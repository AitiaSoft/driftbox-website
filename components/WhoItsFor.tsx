...
const personas = [
  {
    ...
    outcome: 'DriftBox gives you a single view of every conversation you\'re part of across every platform — so you lead instead of chase threads.',
    icon: (
  ...
  },
  {
    ...
    outcome: 'DriftBox summarizes your conversations across every channel — so you know what matters without reading 200 messages.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    outcome: 'DriftBox tracks every commitment, deadline, and follow-up from your conversations — so nothing slips and no client feels forgotten.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
